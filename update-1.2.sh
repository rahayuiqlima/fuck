...
wget -O addd-ssh "https://raw.githubusercontent.com/rezakojexs/fuck/main/add-ssh.sh"
...
wget -O add-sstp "https://raw.githubusercontent.com/rezakojexs/fuck/main/add-sstp.sh"
